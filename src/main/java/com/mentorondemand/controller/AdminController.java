...
public class AdminController {
	...
	public void getAdminDetails(@RequestBody Admin admin) {
		Admin adminDetails = adminRepo.save(new Admin(admin.getName(), admin.getEmail(), admin.getPassword(),
				admin.getContact(), admin.getStatus(), admin.getRole()));
	...
	public Payments paymentDetails(@RequestBody Payments payments) {
		...
		Payments paymentList = paymentRepo
				.save(new Payments(payments.getMentorPaymentId(), payments.getMentorId(), payments.getSkillId(),
						payments.getSlot1(), payments.getSlot2(), payments.getSlot3(), payments.getSlot4()));
		return paymentList;
	}
	...
	public PaymentHistory paymentHistory(@RequestBody PaymentHistory paymentHistory) {
		...
		PaymentHistory paymentHistoryList = paymentHistoryRepo.save(new PaymentHistory(paymentHistory.getUserId(),
				paymentHistory.getSkillId(), paymentHistory.getPaymentAmount()));
